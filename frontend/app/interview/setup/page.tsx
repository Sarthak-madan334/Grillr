    ...
    try {
      ...
      setError(
        caught instanceof Error
          ? caught.message
          : "We could not create this interview.",
      );
    ...
    <main className="min-h-screen text-[#241d1a]">
      ...
      <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#7a5f48]">
              Interview setup
            </p>
            <h1 className="mt-2 text-3xl font-semibold text-[#201a17]">
          ...
          >
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) =>
                  updateField(
                    "interviewType",
                    value as SetupFormState["interviewType"],
                  )
                }
                options={[
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) =>
                  updateField(
                    "experienceLevel",
                    value as SetupFormState["experienceLevel"],
                  )
                }
                options={[
                  { value: "mid", label: "Mid" },
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) =>
                  updateField(
                    "difficulty",
                    value as SetupFormState["difficulty"],
                  )
                }
                options={[
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) =>
                  updateField(
                    "personality",
                    value as SetupFormState["personality"],
                  )
                }
                options={[
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onChange={(value) =>
                  updateField("duration", value as SetupFormState["duration"])
                }
                options={[
            ...
            {error ? (
              <p
                role="alert"
                className="md:col-span-2 border-l-2 border-[#b8916d] pl-3 text-sm leading-6 text-[#8a4f36]"
              >
                {error}
              </p>
            ) : null}
            ...
            <div className="flex flex-col gap-3 md:col-span-2 sm:flex-row sm:items-center sm:justify-end">
              <Link
                href="/dashboard"
                className="text-center text-sm font-medium text-[#755d4a] hover:text-[#201a17]"
              >
                Cancel
              </Link>
              <Button
                size="lg"
                type="submit"
                disabled={!formState.jobTitle.trim() || isSubmitting}
              >

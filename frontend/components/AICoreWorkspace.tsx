...
function Icon({ name }: { name: "back" | "spark" | "send" | "stop" | "plus" | "copy" | "check" | "chevron" | "sliders" | "trash" | "alert" }) {
  const paths = {

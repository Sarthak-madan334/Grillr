        ...
        <div className="hidden items-center gap-3 md:flex">
          {isAuthenticated ? (
            <button
              ...
              className="rounded-full px-2 py-2 text-sm font-medium text-[#424245] transition hover:bg-[#f5f5f7] sm:px-4"
            >
              Log out
            </button>
          ) : (
              ...
              <div className="space-y-1">
                {isAuthenticated ? (
                  <button
                    ...
                    className="flex w-full min-h-11 items-center rounded-xl px-3 text-sm font-medium text-[#473a2d] transition hover:bg-[#f2e5d7] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8f6b4d] focus-visible:ring-inset motion-reduce:transition-none"
                  >
                    Log out
                  </button>
                ) : (
